...
@exnodes=<./Fields.part*.exnode>;
@exelems=<./Fields.part*.exelem>;
...
gfx define field "deformed_geom" component Dependent2.1 Dependent2.2 Dependent2.3
gfx define field "hydrostatic_pressure" component Dependent2.4
