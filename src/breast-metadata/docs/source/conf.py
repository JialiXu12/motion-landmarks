...
project = 'breast-metadata'
copyright = '2020, Thiranja Prasad Babarenda Gamage, Gonzalo Maso Talou'
author = 'Thiranja Prasad Babarenda Gamage, Gonzalo Maso Talou'
...
html_logo = 'images/abi-vc-rgb.png'
